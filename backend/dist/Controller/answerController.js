...
const createAnswer = async (req, res) => {
  const {
    id
  } = req.params; // Extract questionid from route params
  const {
    userID,
    content
  } = req.body; // Extract userID and content from request body
  ...
  try {
    ...
    const insertAnswerQuery = "INSERT INTO answers (userid, questionid, content) VALUES (?, ?, ?)";
