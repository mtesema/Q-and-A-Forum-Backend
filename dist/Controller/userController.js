...
const register = async (req, res) => {
  ...
  try {
    ...
    const checkUserQuery = "SELECT username, userid FROM users WHERE email = ? OR username = ?";
    ...
    const insertUserQuery = "INSERT INTO users (username, firstname, lastname, email, password) VALUES (?, ?, ?, ?, ?)";
